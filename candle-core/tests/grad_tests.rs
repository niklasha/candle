...
test_device!(sum_grad, sum_grad_cpu, sum_grad_gpu, sum_grad_metal, sum_grad_vulkan);
test_device!(
    matmul_grad,
    matmul_grad_cpu,
    matmul_grad_gpu,
...
test_device!(unary_grad, unary_grad_cpu, unary_grad_gpu, unary_grad_metal, unary_grad_vulkan);
test_device!(
    binary_grad,
    binary_grad_cpu,
    binary_grad_gpu,
